...
public class SpaDayController {
    ...
    public String customerForm () {
        String html = "<form method = 'post' action='/menu'>" +// add bonus mission path to open to localhost:8080/menu
                "Name: <br>" +
                ...
                "<option value = 'both'>Both</option>" + // add option for both (bonus mission)
                "</select><br>" +
    ...
    @PostMapping(value="menu")//adding the path to menu from bonus mission sofrom value="" to value="menu"
